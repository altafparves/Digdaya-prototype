...
const data = [
  { name: 'Mon', price: 12100 },
  { name: 'Tue', price: 12200 },
  { name: 'Wed', price: 12400 },
  { name: 'Thu', price: 12300 },
  { name: 'Fri', price: 12500 },
  { name: 'Sat', price: 12700 },
  { name: 'Sun', price: 12850 },
];
  ...
  return (
    <div className="bg-surface-lowest rounded-md p-5 shadow-[0_4px_24px_rgba(24,28,32,0.06)] border border-outline-variant/15 w-full h-[300px] flex flex-col">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xs font-extrabold text-on-surface-variant uppercase tracking-widest">Price Trend (7 Days)</h3>
      </div>
